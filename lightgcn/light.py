...
print("CUDAat light",device)
path = osp.join(osp.dirname(osp.realpath(__file__)), '..', 'data', 'Amazon')
#dataset = AmazonBook(path)
#data = dataset[0]
#print(data)
from yc2 import YOUCHOOSE
from rr2 import RETAILROCKET
#data = YOUCHOOSE()
data = RETAILROCKET()
print(data)
...
print(data.edge_index.device)  # Check the device of edge_index
print(next(model.parameters()).device)  # Check the device of the model
